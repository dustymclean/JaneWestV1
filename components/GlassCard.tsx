    ...
    <div className="flex flex-col items-center justify-center w-full max-w-[500px] mx-auto overflow-visible py-10">
      ...
      >
        ...
        <div className={`relative w-full h-full duration-1000 preserve-3d transition-transform ease-in-out ${isFlipped ? 'rotate-y-180' : ''}`}>
          ...
          {/* Front Face */}
          <div className="absolute inset-0 w-full h-full backface-hidden rounded-[32px] overflow-hidden glass-glow rose-gold-glass flex flex-col shadow-2xl border border-white/40">
            {/* Glossy Overlay for glass effect */}
            <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-rose-200/10 pointer-events-none z-0"></div>
            ...
            <div className="relative z-10 w-full h-full p-8 sm:p-10 flex flex-col justify-between text-rose-950">
              ...
              <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
                ...
                <div className="w-20 h-20 sm:w-28 sm:h-28 bg-white/60 p-2 sm:p-3 rounded-2xl border border-white/80 shadow-sm flex items-center justify-center backdrop-blur-md overflow-hidden transform group-hover:scale-105 transition-transform duration-500">
                  <img 
                    src={qrCodeUrl} 
                ...
                <div className="text-center">
                  <div className="text-xs sm:text-sm tracking-[0.3em] font-black uppercase text-rose-950/90 mb-1 etch-shadow">janewest.com</div>
                  <div className="text-[10px] sm:text-[11px] font-bold tracking-widest text-rose-800/40 uppercase">{JANE_WEST_CONTACT.email}</div>
                </div>
              ...
              {/* Footer */}
              <div className="flex justify-between items-end border-t border-rose-950/5 pt-4">
                <div className="text-[8px] sm:text-[9px] uppercase tracking-[0.25em] font-black serif text-rose-950/40 italic">
                  {JANE_WEST_CONTACT.tagline}
                </div>
                <div className="flex space-x-1.5 pb-1 opacity-20">
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-[32px] overflow-hidden glass-glow rose-gold-glass shadow-2xl border border-white/40">
            {/* Blank Phantom Glass Effect */}
            <div className="absolute inset-0 backdrop-blur-3xl bg-pink-50/10"></div>
            ...
            <div className="relative z-10 w-full h-full p-8 sm:p-10 flex flex-col justify-center items-center text-rose-950 text-center">
              <div className="space-y-6 w-full flex flex-col items-center">
                ...
                {/* Tagline */}
                <div className="py-5 w-full border-y border-rose-950/5">
                  <div className="text-xs sm:text-base font-black uppercase tracking-[0.5em] text-rose-500">
                ...
                {/* Mobile visible action on back too */}
                <div onClick={(e) => e.stopPropagation()} className="pt-4 relative z-20">
                  <VCFButton light />
                </div>
              </div>
            </div>
      ...
      <p className="mt-8 text-[10px] text-rose-400 uppercase tracking-[0.5em] font-black animate-pulse opacity-60">
        Tap to interact
      </p>
    </div>
  );
